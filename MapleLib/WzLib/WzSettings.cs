...
namespace MapleLib.WzLib
{
    public class WzSettingsManager
    {
        ...
        public WzSettingsManager(string wzPath, Type userSettingsType, Type appSettingsType, Type xnaColorType) : this(wzPath, userSettingsType, appSettingsType)
        {
        ...
        public void Load()
        {
            ...
            {
                var wzFile = new WzFile(wzPath, 1337, WzMapleVersion.CLASSIC);
                try
                {
                    wzFile.ParseWzFile();
