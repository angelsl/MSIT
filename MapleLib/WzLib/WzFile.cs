...
namespace MapleLib.WzLib
{
    ...
    public class WzFile : IWzFile
    {
        ...
        internal void ParseMainWzDirectory()
        {
            ...
            var reader = new WzBinaryReader(File.Open(path, FileMode.Open), WzIv);
        ...
        private void CreateVersionHash()
        {
            ...
            uint a = (versionHash >> 24) & 0xFF, b = (versionHash >> 16) & 0xFF, c = (versionHash >> 8) & 0xFF, d = versionHash & 0xFF;
        ...
        public List<IWzObject> GetObjectsFromWildcardPath(string path)
        {
            ...
            {
                var fullList = new List<IWzObject>();
            ...
            var objList = new List<IWzObject>();
